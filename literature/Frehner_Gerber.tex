...
\begin{figure}[h] % [h] = "here", direkt an dieser Stelle
    ...
    \caption{Classification of non-life contracts \cite{LinKwon}}
    \label{fig:beispiel}
\end{figure}
...
\begin{table}[H] 
    ...
    \begin{tabular}{|p{2.25cm}|p{5cm}|p{5cm}|}
        ...
        \midrule \hline\hline
        Recovery & Reimbursement of adjusted loss & Pre-agreed payment structure based on a event parameter (often binary) \\\hline
        ...
        Loss assessment and payment & Complex and based on loss adjuster assessment & Transparent, predictable, based on a parameter, quick settlement \\\hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|p{2.25cm}|p{2.25cm}|p{2.25cm}|p{2.25cm}|p{2.25cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Risk categories based on quantiles of number of annual rainy days}
...
\[
\text{premium}
= \text{coverage} \cdot (D_{\text{tot}} - D_{\text{ded}} ) \cdot \mu_X \cdot \Phi
\]
...
\begin{figure}[h] % [h] = "here", direkt an dieser Stelle
    \centering
    \includegraphics[width=0.9\textwidth]{weather_2025_Sep} % Dateiname des Bildes
    \caption{example of a triggered parametric weather insurance \\ (Calculations and Plotting done using R, see file example\_plotting.R):}
    \label{fig:bsp_trigger}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{flow_chart_3}
...
\bibitem{Szabo1997}
N. Szabo, \textit{The Idea of Smart Contracts}, 1997. \url{https://nakamotoinstitute.org/library/the-idea-of-smart-contracts/}. Accessed, November 13, 2025.

\bibitem{Buterin2014}
V. Buterin, \textit{A Next-Generation Smart Contract and Decentralized Application Platform}, Ethereum Whitepaper, 2014. \url{https://ethereum.org/whitepaper/}. Accessed, November 6, 2025.

\bibitem{Wood2014}
G. Wood, \textit{Ethereum: A Secure Decentralised Generalised Transaction Ledger}, Ethereum Yellow Paper, 2014. \url{https://cryptodeep.ru/doc/paper.pdf}. Accessed, November 8, 2025.

\bibitem{Antonopoulos2018}
A. M. Antonopoulos and G. Wood, \textit{Mastering Ethereum}, O'Reilly Media, 2018. \url{https://github.com/ethereumbook/ethereumbook}. Accessed, November 8, 2025.
