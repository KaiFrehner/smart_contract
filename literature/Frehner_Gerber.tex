...
\paragraph*{Pricing}
Due to the secrecy around the pricing of the Baloise product, the premium calculation is considered out of scope for this project. In order to test the smart contract a simplified and rudimentary formula is used to obtain a premium dependent on the \textbf{duration} of insured trip, the amount of  \textbf{coverage}, the amount of \textbf{deductible days} and a rudimentary estimation of the \textbf{likelihood of rain in the insured area}.

\[
\text{premium} = \text{coverage} \ (\text{duration} - \text{thresholdForRegion}) \   \mu_X \  \Phi
\]
with $\Phi = \frac{11}{10}$ as safty margin.
...
\paragraph*{Outline of Trigger Function}
