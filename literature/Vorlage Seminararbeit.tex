...
\vspace{2.5cm}
\begin{center}                     
        {\Large\scshape Seminararbeit}\\*[5mm]
				{\Large\scshape M.Sc.-Studiengang "`Actuarial Science"'}\\*[5mm]
        {\bf\Large\scshape Titel der Seminararbeit}\\*[12mm]         
\end{center}  
\vspace{4,5cm}
\begin{tabbing}
       eingereicht von:		\hspace{6.5cm}\=			betreut von:\\*[2mm]
       \bf{Name des Autors} 								\> \bf{Name des Betreuers}\\*[2mm]		
        Matrikel--Nr.:  \\*[2mm]
        \textbf{Straße \& Hausnummer}										\> Abgabedatum, Ort: \\*[2mm]
        \textbf{PLZ \& Ort}		   							\> \textbf{XX.XX.XXXX, Ort}   \\*[2mm]
        Telefon: \\*[2mm]
        Email: \\*[2mm]
\end{tabbing}
\end{titlepage}
